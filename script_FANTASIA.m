...
options = CNMFSetParms(...   
    ...
    'space_thresh', 0.1,...                     % threshold for classify_comp_corr
    'time_thresh', 0.2);                        % threshold for classify_comp_corr
...
% ==== this is the major step that throws away a lot of ROIs ====
% fitness = compute_event_exceptionality(C+YrA,options.N_samples_exc,options.robust_std);
% ind_exc = (fitness < options.min_fitness);
ind_exc = ones(size(ind_cnn)); ind_exc = logical(ind_exc);
